* Contents :TOC:
 ...
 - [[#plans][Plans]]
     ...
     - [[#try-alternative-split-string-instead-of-s-slice-at][Try alternative split-string instead of s-slice-at]]
...
** TODO Try alternative split-string instead of s-slice-at

[[http://emacs.stackexchange.com/a/5730][According to abo-abo]], this should be better than =s-slice-at=:
