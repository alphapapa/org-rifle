* Contents :TOC:
 - [[#code][Code]]
     - [[#profiling][Profiling]]
     - [[#open-helm-session-on-current-org-buffers][Open Helm session on current org buffers]]
     - [[#get-list-of-candidates-for-testorg-buffer][Get list of candidates for "test.org" buffer]]
     - [[#context-splitting][Context-splitting]]
     - [[#underway-elp-profiling][UNDERWAY elp profiling]]
     - [[#buffer-name-matching][buffer-name-matching]]
     - [[#matching-symbol-parts][Matching symbol parts]]
     - [[#order-sensitive-matching][Order-sensitive matching]]
     - [[#hyphenated-words-cause-order-sensitive-matching][Hyphenated words cause order-sensitive matching?]]
     - [[#priority][Priority]]
     - [[#match-and-show-tags][Match and show tags]]
     - [[#negation][Negation]]
 - [[#plans][Plans]]
